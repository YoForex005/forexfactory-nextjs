...
import { Save, Eye, ArrowLeft, Trash2, ChevronDown, Search } from "lucide-react";
      ...
      <div className="grid gap-8 lg:grid-cols-3">
        ...
        <div className="space-y-6">
          ...
          <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
            ...
            <div
              className={`inline-flex rounded-full px-4 py-2 text-sm font-medium ${formData.status === "published"
                ...
                <div className="aspect-video overflow-hidden rounded-lg bg-zinc-800">
                  <img
                    ...
                    onError={(e) => {
                      ...
                      e.currentTarget.parentElement!.innerHTML = '<div class="flex h-full items-center justify-center text-zinc-500 text-sm">Failed to load image</div>';
                    }}
                    onLoad={() => console.log("Image loaded successfully:", formData.featuredImage)}
                  />
                </div>
              </div>
            )}
        ...
        {seoExpanded && (
          <div className="border-t border-white/10 p-6 space-y-6">
            ...
            <div className="grid gap-6 md:grid-cols-2">
              ...
              <div>
                <label htmlFor="metaTitle" className="mb-2 block text-sm font-medium text-zinc-300">
                  Meta Title
                </label>
                <input
                  type="text"
                ...
                />
                <p className="mt-1.5 text-xs text-zinc-500">{formData.metaTitle.length}/60</p>
              </div>
            </div>

            {/* Meta Description */}
            <div>
              <label htmlFor="metaDescription" className="mb-2 block text-sm font-medium text-zinc-300">
                Meta Description
              </label>
              <textarea
                id="metaDescription"
              ...
              />
              <p className="mt-1.5 text-xs text-zinc-500">{formData.metaDescription.length}/160</p>
            </div>
