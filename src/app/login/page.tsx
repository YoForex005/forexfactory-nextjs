                    ...
                    <div className="bg-[#0d0d14] rounded-2xl border border-white/10 p-8">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5">
                            ...
                            <div className="flex items-center justify-between">
                                <label className="flex items-center gap-2 cursor-pointer">
                                    <input
                                        ...
                                        className="w-4 h-4 rounded border-white/20 bg-white/5 text-brand focus:ring-brand/20 focus:ring-offset-0"
                                    />
                            ...
                            <button
                                type="submit"
                                disabled={isLoading}
                                className="w-full rounded-lg bg-brand py-3 text-sm font-semibold text-white hover:bg-brand/90 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                            >
                                {isLoading ? (
                                    <>
                        ...
                        <button
                            type="button"
                            className="w-full flex items-center justify-center gap-3 rounded-lg border border-white/10 bg-white/5 py-3 text-sm font-medium text-zinc-300 hover:bg-white/10 hover:text-white transition-colors"
                        >
